document.addEventListener('DOMContentLoaded', function() {
  ...
  var textReplies = function() {
    switch(textInputValueLowerCase){
      ...
      case "Panos":
        clearInput();
        addTextToResults("He's my maker <a target='_blank' href='https://www.linkedin.com/in/ppanteleakos/</a>");
        break;

      case "Panteleakos":
        clearInput();
        addTextToResults("He's my maker <a target='_blank' href='https://www.linkedin.com/in/ppanteleakos/</a></a>");
        break;

      case "THOS":
        clearInput();
        addTextToResults("An awesome designer/developer friend of mine. <br> He helped me a bit with the CSS animation <a target='_blank' href='https://twitter.com</a>");
        break;

      case "BookingHistory":
        clearInput();
        addTextToResults("Incapable Management");
        break;
        
      case "panoulis":
        clearInput();
        addTextToResults("🍌 + <a target='_blank' href='https://www.linkedin.com/in/ppanteleakos/</a>");
        break;
      ...
      case "git":
        clearInput();
        addTextToResults("git push origin master <br>you can check this project's repo on GitHub:");
        break;
